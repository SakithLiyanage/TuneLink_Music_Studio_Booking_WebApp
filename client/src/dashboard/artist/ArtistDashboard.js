...
import { FiCalendar, FiUser, FiEdit, FiClock, FiChevronRight } from 'react-icons/fi';
...
const ArtistDashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8">
      <h1 className="text-2xl md:text-3xl font-bold mb-1">Artist Dashboard</h1>
      <p className="text-gray-600 mb-8">Manage your bookings and profile</p>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <Link to="/artist/profile" className="bg-white p-5 rounded-xl shadow-soft flex items-center space-x-4 hover:shadow-md transition-shadow">
          <div className="w-12 h-12 rounded-lg bg-primary-100 text-primary-600 flex items-center justify-center">
            <FiUser size={22} />
          </div>
          <div>
            <h3 className="font-semibold">Edit Profile</h3>
            <p className="text-gray-600 text-sm">Update your artist info</p>
          </div>
          <FiChevronRight className="ml-auto text-gray-400" />
        </Link>
        <Link to="/artist/bookings" className="bg-white p-5 rounded-xl shadow-soft flex items-center space-x-4 hover:shadow-md transition-shadow">
        ...
        <Link to="/artist/availability" className="bg-white p-5 rounded-xl shadow-soft flex items-center space-x-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex">
                  <div className="p-4 flex-1">
                    ...
                    <div className="mt-2 text-right">
                      <Link to={`/artist/bookings/${booking._id}`} className="text-primary-600 text-sm">
                        View Details
                      </Link>
                    </div>
                  </div>
