      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div className="flex items-center mb-8 gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-extrabold text-primary-700 mb-1">Studio Bookings</h1>
              <p className="text-dark/60 text-lg">Manage your studio bookings</p>
            </div>
          </div>
          {bookings.length === 0 ? (
